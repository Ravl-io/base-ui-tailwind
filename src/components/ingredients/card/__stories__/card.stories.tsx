...
import {
  ...
  CardHeader,
  CardTitle,
} from "@/components/ingredients/card";
...
export const ShouldExposeDistinctContentRegions: Story = {
  name: "should expose title, description, and content to AT (WCAG 1.3.1)",
  tags: ["!dev", "!autodocs"],
  render: (args) => (
    <Card {...args}>
      <CardHeader>
